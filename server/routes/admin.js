...
const { getDashboardStats, getCitizens, uploadNINs, getRegistrations } = require('../controllers/adminController');
...
router.get('/registrations', authorize('admin', 'officer_read'), getRegistrations);
